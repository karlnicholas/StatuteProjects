...
public class StatutesParser {
   ...
   public StatutesRoot parse(ParserInterface parserInterface, Charset encoding, Path file) throws FileNotFoundException  { 
       ...
       try {
	       ...
	       StatutesRoot code = new StatutesRoot( statutesTitle, parserInterface.getShortTitle(statutesTitle));
...
//                    	   codeMember = new Subcode( parent, part, partNumber, title, (secStack.size()>0?secStack.size():1) );
                    	   codeMember = new StatutesNode( parent, part, partNumber, adjTitle, secStack.size() );
                       } else {
...
//                    	   codeMember = new Section(parent, part, partNumber, title, range, (secStack.size()>0?secStack.size():1) );
                    	   codeMember = new StatutesLeaf(parent, part, partNumber, adjTitle, range, secStack.size() );
                       }
